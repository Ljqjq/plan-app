...
const Login = () => {
  ...
  return (
    <div className="flex flex-col gap-4 p-4 max-w-sm mx-auto bg-white rounded-md shadow-md">
      ...
      <button className="bg-green-500 text-white p-2 rounded hover:bg-green-600" onClick={handleSubmit(signUp)}>
        Register
      </button>

      <div className="border-t pt-4">
        <button className="bg-red-500 text-white p-2 rounded hover:bg-red-600 w-full" onClick={signInWithGoogle}>
          Sign In with Google
        </button>
      </div>
    </div>
